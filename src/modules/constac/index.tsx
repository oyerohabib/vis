...
const ContactUs = () => {
  return (
    <main className=" overflow-hidden mt-[50px] md:mt-[100px] md:mb-[100px]">
      <motion.section
        initial={{ y: 100, opacity: 0 }}
        whileInView={{ y: 0, opacity: 1 }}
        transition={{ delay: 0.05, duration: 0.75, ease: [0.16, 1, 0.3, 1] }}
        className="flex flex-col px-5 md:container"
      >
        ...
        <section className="w-full xl:py-24 lg:py-20 py-12">
          <div className="w-full">
            <div className="grid lg:grid-cols-2 grid-cols-1 gap-x-16 xl:gap-x-24 gap-y-14 max-w-lg md:max-w-3xl lg:max-w-full mx-auto">
              <div>
                ...
                <div className="my-12 grid md:grid-cols-2 grid-cols-1 md:gap-x-8 gap-y-8">
                  <div className="rounded-2xl border border-gray-200 bg-white p-7 group transition-all duration-500 hover:bg-primary">
                    <div className="w-14 h-14 bg-primary rounded-full flex items-center justify-center mb-5 transition-all duration-500 group-hover:bg-white cursor-pointer">
                      <svg
                    ...
                    <p className="text-gray-500 text-sm font-normal leading-5 transition-all duration-500 group-hover:text-white">
                      ...
                      <br /> Call: (+234) 80 855 460 73
                    </p>
                  </div>
                  <div className="rounded-2xl border border-gray-200 bg-white p-7 group transition-all duration-500 hover:bg-primary">
                    <div className="w-14 h-14 bg-primary rounded-full flex items-center justify-center mb-5 transition-all duration-500 group-hover:bg-white cursor-pointer">
                      <svg
                        className="stroke-white transition-all duration-500 group-hover:stroke-primary"
                        width="30"
                        height="30"
                        viewBox="0 0 30 30"
                        fill="none"
                    ...
                    <p className="text-gray-500 text-sm font-normal leading-5 transition-all duration-500 group-hover:text-white">
                      ...
                      <br />
                      Email:{" "}
                      <a href="mailto:support@visco.com.ng">
                        support@visco.com.ng
                      </a>
                      <br />
                      Office: Polystar 2nd Roundabout, Lekki Phase 1 105102,
                      Lagos
                    </p>
                  </div>
                </div>
                <div className="border-t border-slate-200 pt-12 flex lg:justify-start justify-center">
                  <div className="flex gap-x-1 border-r border-indigo-300 items-center">
                    ...
                    <span className="text-indigo-900 text-lg font-normal leading-7 pl-2.5 pr-3.5">
                      4.9 Rating
                    </span>
                  </div>
                  <span className="pl-3.5 text-indigo-900 text-lg font-normal leading-7">
                    163 Reviews
                  </span>
                </div>
              </div>
              <form
                action=""
                className="h-fit bg-white border border-slate-200 rounded-2xl lg:p-12 p-4 w-full max-w-lg md:max-w-3xl lg:max-w-full"
              >
                ...
                <button className="w-full h-12 rounded-full bg-primary hover:bg-indigo-900 transition-all duration-700 shadow-sm text-white text-base font-semibold leading-6 flex items-center justify-center">
                  Send message{" "}
                  <svg
                    width="20"
                    height="20"
      ...
      >
        <iframe
          src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3964.6504987603735!2d3.4817529999999994!3d6.438911299999999!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x103bf5f3726d455b%3A0xa2080292cedc2e88!2sViscio%20Express!5e0!3m2!1sen!2sng!4v1716884639057!5m2!1sen!2sng"
          width="100%"
          height="480"
          allowFullScreen
          loading="lazy"
