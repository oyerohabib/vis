...
const SwipeIndicator = () => {
  ...
  return (
    ...
    >
      ...
      <button
        type="button"
        className="text-white bg-gray-950 dark:border-success/60 border-border border px-3 py-1 rounded-md mt-1 font-medium uppercase active:scale-75 transition-all duration-300"
        onClick={() => {
