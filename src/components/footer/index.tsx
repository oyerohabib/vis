    ...
    <footer className="w-full py-20 bg-primary">
      <div className="mx-auto w-full px-4 sm:px-8 xl:px-16 2xl:px-24">
        <div className="flex items-center justify-center lg:justify-between flex-col lg:flex-row pb-12 gap-7 lg:gap-0 border-b border-gray-200">
          ...
          <Link
            href="/"
            className="flex items-center gap-2 py-3.5 px-7 rounded-full bg-white shadow-md text-primary font-semibold hover:bg-white"
          >
            Contac us{" "}
            <svg
              width="17"
        ...
        <div className="flex justify-between flex-col py-8 min-[500px]:py-14 gap-8 min-[500px]:gap-16 lg:gap-0 lg:flex-row">
          ...
          <div className="block lg:max-w-md">
            ...
            <div className="lg:bg-gray-100 lg:rounded-full lg:h-16 lg:p-1.5 lg:flex-row gap-6 lg:gap-0 flex-col flex items-center justify-between">
              ...
              <button
                type="submit"
                className="py-3.5 px-7 bg-primary shadow-md rounded-full text-white font-semibold hover:bg-primary/80"
              >
                Subscribe
              </button>
            </div>
        ...
        <div className="py-9 border-t border-gray-200">
          <div className="flex items-center justify-center flex-col gap-8 lg:gap-0 lg:flex-row lg:justify-between">
            ...
            <div className="flex mt-4 space-x-4 sm:justify-center sm:mt-0 ">
              ...
              >
                <svg
                  className="w-[1.25rem] h-[1.125rem] text-white hover:text-primary"
                  viewBox="0 0 15 15"
                  fill="none"
                  xmlns="http://www.w3.org/2000/svg"
                >
              ...
              >
                <svg
                  className="w-[1rem] h-[1rem] text-white hover:text-primary"
                  viewBox="0 0 13 12"
                  fill="none"
                  xmlns="http://www.w3.org/2000/svg"
                >
              ...
              >
                <svg
                  className="w-[1.25rem] h-[0.875rem] text-white hover:text-primary"
                  viewBox="0 0 16 12"
                  fill="none"
                  xmlns="http://www.w3.org/2000/svg"
                >
