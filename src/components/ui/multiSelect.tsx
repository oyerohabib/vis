...
const controlStyles = {
  ...
  nonFocus: "border-primary hover:border-primary/40",
};
...
const multiValueStyles =
  "bg-primary rounded-lg text-primary items-center py-0.5 pl-2 pr-1 gap-1.5";
...
const menuStyles = "p-1 mt-2 border border-primary bg-white rounded-lg";
